...
export function addConditionRow(parentContainer, conditionData = {}) {
    ...
    function renderOptions(selectedType, data = {}) {
        ...
        if (selectedType === 'tags') {
            ...
            ratingServiceSelect.addEventListener('change', () => renderRatingInputs(ratingServiceSelect.value, {})); // Pass empty data on change
            ...
            subtypeSelect.addEventListener('change', () => renderUrlSubtypeInputs(subtypeSelect.value, {}));
