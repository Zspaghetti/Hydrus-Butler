...
# --- Configuration ---
PYTHON_EXE="python3" # Or just "python" if python3 is the default/aliased
VENV_DIR="venv"
...
# The 'deactivate' command is available after sourcing activate.
# It's good practice to explicitly call it, especially if the script might be sourced.
